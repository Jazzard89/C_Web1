...
namespace SlideTester.Controllers
{
    ...
    {
        private readonly TesterDbContext _context;

        public StoreController(TesterDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Products != null ? 
                          ...
                          Problem("Entity set 'TesterDbContext.Products'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TesterDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
