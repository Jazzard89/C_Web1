    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BestellingsRegels", x => x.BestellingsRegelId);
                    table.ForeignKey(
                        name: "FK_BestellingsRegels_Bestellingen_BestellingId",
                        column: x => x.BestellingId,
                        principalTable: "Bestellingen",
                        principalColumn: "BestellingId");
                    table.ForeignKey(
                        name: "FK_BestellingsRegels_Boeken_BoekId",
                        column: x => x.BoekId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BestellingsRegels_BoekId",
                table: "BestellingsRegels",
                column: "BoekId");
        }
