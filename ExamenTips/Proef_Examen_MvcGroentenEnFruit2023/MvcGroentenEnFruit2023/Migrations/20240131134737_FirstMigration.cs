        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AankoopDatum = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderLijnId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AankoopOrderId = table.Column<int>(type: "int", nullable: true),
                    ArtikelId = table.Column<int>(type: "int", nullable: false),
                    Aantal = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Orderlijns", x => x.OrderLijnId);
                    table.ForeignKey(
                        name: "FK_Orderlijns_AankoopOrders_AankoopOrderId",
                        column: x => x.AankoopOrderId,
                        principalTable: "AankoopOrders",
                        principalColumn: "AankoopOrderId");
                    table.ForeignKey(
                        name: "FK_Orderlijns_Artikels_ArtikelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orderlijns_AankoopOrderId",
                table: "Orderlijns",
                column: "AankoopOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Orderlijns_ArtikelId",
                table: "Orderlijns",
                column: "ArtikelId");
        }
